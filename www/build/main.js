...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__product_model_product_model__ = __webpack_require__(214);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_rest_rest__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__app_common_baseui__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_network__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ionic_storage__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__read_sals_order_categories_read_sals_order_categories__ = __webpack_require__(133);
...
var SalsOrderPage = (function (_super) {
    ...
    function SalsOrderPage(formBuilder, viewCtrl, alerCtrl, modalCtrl, rest, navParams, loadingCtrl, toastCtrl, navCtrl, storage, network) {
        ...
        _this.orderId = "";
        _this.hadSubmit = false;
        _this.disableDepts = false;
        ...
        if (this.network.type != 'none') {
            this.rest.GetSalesOrderByOrderId(title)
                ...
                if (f.Success) {
                    ...
                    var temp = _this.orderForm.value;
                    _this.orderId = orderDetail.commandeId;
        ...
        if (this.network.type != 'none') {
            this.rest.InsertSalesOrderByOrderId(this.orderForm.value, this.listProduct)
                ...
                if (f.Success) {
                    ...
                    _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_8__read_sals_order_categories_read_sals_order_categories__["a" /* ReadSalsOrderCategoriesPage */]);
                }
                else {
                    // alert("保存失敗 : "+f.msg);
    ...
    SalsOrderPage.prototype.presentModal = function (infoProduct, index) {
        ...
        if (infoProduct == undefined) {
            if (this.hadSubmit) {
                _super.prototype.showToast.call(this, this.toastCtrl, "订单已提交,不可添加! ");
                return;
            }
            modal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_3__product_model_product_model__["a" /* ProductModelPage */]);
        }
        else {
            modal = this.modalCtrl.create(__WEBPACK_IMPORTED_MODULE_3__product_model_product_model__["a" /* ProductModelPage */], { infoProduct: infoProduct, hadSubmit: this.hadSubmit });
        }
    ...
    SalsOrderPage.prototype.valideSalesOrder = function () {
        var _this = this;
        var commandeId = this.orderId;
        if (commandeId != null && commandeId != "" && this.readModel) {
            var loading = _super.prototype.showLoading.call(this, this.loadingCtrl, "正在提交，请稍等");
            if (this.network.type != 'none') {
                this.rest.UpdateSalesOrderStatut(commandeId, "1") //1: 提交到财务
                    .subscribe(function (f) {
                    if (f.Success) {
                        _super.prototype.showToast.call(_this, _this.toastCtrl, "提交成功");
                        if (_this.readModel) {
                            //var callback = this.navParams.get('callback');
                            //callback(true).then(() => {this.navCtrl.pop();});
                            _this.navCtrl.setRoot(__WEBPACK_IMPORTED_MODULE_8__read_sals_order_categories_read_sals_order_categories__["a" /* ReadSalsOrderCategoriesPage */]);
                        ...
                        // alert("保存失敗 : "+f.msg);
                        _super.prototype.showToast.call(_this, _this.toastCtrl, "提交失敗 : " + f.Msg);
                    }
                    loading.dismiss();
                }, function (error) {
                    loading.dismiss();
                    _super.prototype.showToast.call(_this, _this.toastCtrl, "提交失敗 : " + error); //TODO: cannot show the detail information for the user
                });
            }
            else {
                _super.prototype.showToast.call(this, this.toastCtrl, "您处于离线状态，请连接网络! ");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__app_common_baseui__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_network__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__read_sals_order_read_sals_order__ = __webpack_require__(157);
...
var ReadSalsOrderCategoriesPage = (function (_super) {
    ...
    function ReadSalsOrderCategoriesPage(navCtrl, navParams, network, rest, toastCtrl, loadingCtrl, storage) {
        var _this = _super.call(this) || this;
        _this.navCtrl = navCtrl;
        _this.navParams = navParams;
        _this.network = network;
    ...
    ReadSalsOrderCategoriesPage.prototype.initSalsOrdersCategoryData = function () {
        var _this = this;
        this.storage.get("userId").then(function (userId) {
            _this.rest.GetSalesOrderCategoriesByUserId(userId, "O")
                .subscribe(function (f) {
                if (f.Success) {
                    _this.loading = false;
                    if (f["Data"].length > 0) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__app_common_baseui__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_network__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__providers_rest_rest__ = __webpack_require__(46);
...
var ReadSalsOrderPage = (function (_super) {
    ...
    ReadSalsOrderPage.prototype.initSalsOrdersData = function () {
        ...
        this.storage.get("userId").then(function (val) {
            ...
            _this.loading = true;
            if (_this.network.type != 'none') {
                _this.rest.GetOrdersByUserId(_this.userId, _this.CategoryId, "O")
                    .subscribe(function (f) {
                    if (f.Success) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_forms__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_rest_rest__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__app_common_baseui__ = __webpack_require__(66);
...
var ProductModelPage = (function (_super) {
    ...
    function ProductModelPage(viewCtrl, formBuilder, navParams, rest, alerCtrl, toastCtrl, network) {
        ...
        var tempHadSubmit = _this.navParams.get('hadSubmit');
        if (tempHadSubmit != undefined)
            _this.hadSubmit = tempHadSubmit;
        if (!_this.hadSubmit)
            _this.initProducts();
        return _this;
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_list_list__ = __webpack_require__(354);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__ionic_native_status_bar__ = __webpack_require__(352);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__ionic_native_splash_screen__ = __webpack_require__(353);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__pages_product_model_product_model__ = __webpack_require__(214);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__providers_rest_rest__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__pages_read_sals_order_read_sals_order__ = __webpack_require__(157);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__pages_read_sals_order_categories_read_sals_order_categories__ = __webpack_require__(133);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_rxjs_Rx__ = __webpack_require__(301);
...
var RestProvider = (function () {
    function RestProvider(http, storage) {
        ...
        this.apiUrlUpdateSalesOrderStatut = this.host + "api/SalesOrder/UpdateSalesOrderStatut";
    }
    /*
    * With auth services
    */
    ...
    RestProvider.prototype.GetOrdersByUserId = function (userId, categoryId, type) {
        return this.getUrlReturn(this.apiUrlGetOrdersByUserId + "?userId=" + userId + "&categoryId=" + categoryId + "&type=" + type);
    };
    RestProvider.prototype.GetSalesOrderCategoriesByUserId = function (userId, type) {
    ...
    RestProvider.prototype.UpdateSalesOrderStatut = function (orderId, statusCode) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__pages_read_sals_order_categories_read_sals_order_categories__ = __webpack_require__(133);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
