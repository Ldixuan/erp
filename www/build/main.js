...
var SalsOrderPage = (function () {
    ...
    SalsOrderPage.prototype.onBlur = function (event) {
...
var ProductModelPage = (function () {
    ...
    ProductModelPage.prototype.onBlur = function (event) {
        var val = event.target.value;
        //this.gridShow = false;
        if (val == '') {
            this.gridShow = false;
